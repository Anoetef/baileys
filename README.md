...
<p align="center">
   ...
   <a href="https://www.npmjs.com/package/@skycodee/baileys">
      <img src="https://img.shields.io/npm/v/@skycodee/baileys?style=for-the-badge&logo=npm"/>
   </a>
   <a href="https://www.npmjs.com/package/@skycodee/baileys">
...
>
> To be clear, I’m **not** the original maintainer of Baileys all respect goes to the amazing work behind [@whiskeysockets/baileys](https://github.com/WhiskeySockets/Baileys). I only created and maintained my own fork ([@skycodee/baileys](https://www.npmjs.com/package/@skycodee/baileys)) where I spent a **lot** of time improving and adapting things on my own.
>
...
```javascript
// --- ESM
import { makeWASocket } from '@skycodee/baileys'

// --- CJS (tested and working on Node.js 24 ✅)
const { makeWASocket } = require('@skycodee/baileys')
```

### 🌐 Connect to WhatsApp (Quick Step)

```javascript
import { makeWASocket, delay, DisconnectReason, useMultiFileAuthState } from '@skycodee/baileys'
...
```javascript
import { makeWASocket, makeInMemoryStore, delay, DisconnectReason, useMultiFileAuthState } from '@skycodee/baileys'
import { Boom } from '@hapi/boom'
import pino from 'pino'
...
const groupName = '@skycodee/baileys'
...
sock.sendMessage(jid, {
   ...
   product: {
      ...
      signedUrl: 'https://www.npmjs.com/package/@skycodee/baileys',
      title: '📦 Starseed (Premium)',
      url: 'https://www.npmjs.com/package/@skycodee/baileys'
   },
...
```javascript
import { tokenizeCode } from '@skycodee/baileys'
...
sock.sendMessage(jid, {
   ...
   publisher: '🌟 Skyzopedia',
   description: '@skycodee/baileys'
}, {
   quoted: message
})
```
...
sock.sendMessage(jid, {
   ...
   offerCode: '@skycodee/baileys', // --- Optional
   offerUrl: 'https://www.npmjs.com/package/@skycodee/baileys', // --- Optional
...
sock.sendMessage(jid, {
   ...
   cards: [{
      ...
      offerCode: '@skycodee/baileys',
      offerUrl: 'https://www.npmjs.com/package/@skycodee/baileys',
...
sock.sendMessage(jid, {
   ...
   externalAdReply: {
      ...
      url: 'https://www.npmjs.com/package/@skycodee/baileys' // --- Optional, used for WhatsApp internal thumbnail caching and direct URL
   }
}, {
   quoted: message
})
...
```javascript
import { getImageProcessingLibrary } from '@skycodee/baileys'
...
```javascript
// --- Create a new one
sock.newsletterCreate('@skycodee/baileys', '📣 Fresh updates weekly')
...
// --- Update newsletter
sock.newsletterUpdate('1231111111111@newsletter', { name: '@skycodee/baileys' })

// --- Change name
sock.newsletterUpdateName('1231111111111@newsletter', '📦 @skycodee/baileys')
...
const group = sock.groupCreate('@skycodee/baileys', ['628123456789@s.whatsapp.net'])
...
// --- Change name
sock.groupUpdateSubject(jid, '📦 @skycodee/baileys')
...
sock.updateMemberLabel(jid, '@skycodee/baileys')
```
