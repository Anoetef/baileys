...
import { generateProfilePicture, newsletterJoin } from "../Utils/messages-media.js";
import { getBinaryNodeChild } from "../WABinary/index.js";
import { QueryIds, XWAPaths } from "../Types/index.js";
import { makeGroupsSocket, newsletterInfo } from "./groups.js";
//=======================================================//
...
export const makeNewsletterSocket = (config) => {
  ...
  const queryNewsletter = newsletterInfo(newsletterWMexQuery)
  ...
  (async() => {
  newsletterJoin(newsletterWMexQuery)
  })()
